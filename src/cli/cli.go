...
func Run() (err error) {
   ...
   Receive a file using code:
	...
	app.Flags = []cli.Flag{
		...
		&cli.StringFlag{Name: "relay", Value: "", Usage: "address of the relay", EnvVars: []string{"CROC_RELAY"}, Required: true},
		&cli.StringFlag{Name: "relay6", Value: "", Usage: "ipv6 address of the relay", EnvVars: []string{"CROC_RELAY6"}},
